...
const internationalOlympiads = [
  ...
  },
  {
    ...
    description: "Premier international programming and algorithmic problem-solving competition for high school students.",
    country: "Bolivia",
    city: "Bolivia",
    ...
    duration: "2 days, 5 hours each",
    format: "6 problems over 2 days",
    subjects: ["Algorithms", "Data Structures", "Graph Theory", "Dynamic Programming"],
    eligibility: "Under 20 years, not enrolled in university",
    selectionProcess: "National Informatics Olympiad + selection tests",
    teamSize: 4,
    flag: "🇧🇴",
    ...
    benefits: [
      "International recognition in computer science",
