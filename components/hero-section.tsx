...
const upcomingOlympiads = [
  {
    ...
    description:
      "Representing Uzbekistan on the global stage in the world's premier mathematics competition.",
  ...
  },
  {
    ...
    description:
      "National competition to select the best physics students for international representation.",
  ...
  },
  {
    ...
    description:
      "Regional chemistry competition for students across Central Asia.",
  ...
  },
  {
    ...
    description:
      "Showcase your biological knowledge in this prestigious international competition.",
